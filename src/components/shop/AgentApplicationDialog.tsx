...
type PayoutMethod = 'bank' | 'ecocash' | 'paynow' | 'onemoney' | 'telecash';
...
const AgentApplicationDialog: React.FC<AgentApplicationDialogProps> = ({
  ...
  const handleInputChange = (
    ...
    // Special handling for payoutMethod to preserve type
  ...
  // Helper variable to fix TypeScript type narrowing issue
  const isBankMethod = formData.payoutMethod === 'bank';
